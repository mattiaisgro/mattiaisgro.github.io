...
This new operator evolves our system in time, given the initial conditions, and is really similar to the time evolution of quantum systems $\hat U(t) = e^{\frac{1}{i \hbar} t \hat H}$ with a scalar factor in the exponent which is typical of the change from classical to quantum mechanics (as immediately seen by the exchange of Poisson brackets and commutators).
...
------
In the formalism of quantum mechanics, on the other hand, ...
